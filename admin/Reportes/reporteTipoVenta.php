...
include('../MySqli_conexionDB.php');
	...
	//SELECT Puesto, COUNT(IDUsuario) AS cantUsuarios FROM usuarios GROUP by Puesto
	//SELECT metodoPago, COUNT(IDVenta) AS CantVentas, SUM(importeTotal) AS Monto FROM ventas GROUP by metodoPago
